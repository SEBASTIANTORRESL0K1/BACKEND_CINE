...
CREATE TABLE `historial` (
  ...
  `id_usuario` INT,
  -- Nombre o ID del usuario que realizó la acción
  `fecha_hora` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  -- Momento exacto del evento
  `ip` VARCHAR(45) DEFAULT NULL,
  -- IPv4 o IPv6 del cliente
  `tipo_movimiento` VARCHAR(100) NOT NULL,
  -- Tipo de acción (INSERT, UPDATE, DELETE, LOGIN, LOGOUT, etc.)
  `  descripcion` TEXT DEFAULT NULL,
  -- Descripción más detallada de lo ocurrido
...
ALTER TABLE `clientes`
ADD FOREIGN KEY (`id_membresia`) REFERENCES `membresias` (`id_membresia`);
ALTER TABLE `reserva`
ADD FOREIGN KEY (`id_asiento`) REFERENCES `asientos` (`id_asiento`);
ALTER TABLE `reserva`
...
ADD FOREIGN KEY (`id_categoria_dulceria`) REFERENCES `categoria_dulceria` (`id_categoria_dulceria`);
ALTER TABLE `empleados`
ADD FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`);
ALTER TABLE `detalle_venta`
ADD FOREIGN KEY (`id_dulce`) REFERENCES `dulceria` (`id_dulce`);
ALTER TABLE `detalle_venta`
...
ALTER TABLE `detalle_venta`
ADD FOREIGN KEY (`id_asiento`) REFERENCES `asientos` (`id_asiento`);
ALTER TABLE `stock_dulceria_cines`
ADD FOREIGN KEY (`id_dulce`) REFERENCES `dulceria` (`id_dulce`);
ALTER TABLE `stock_dulceria_cines`
ADD FOREIGN KEY (`id_cine`) REFERENCES `cines` (`id_cine`);
ALTER TABLE `historial`
ADD FOREIGN KEY (`id_usuario`) REFERENCES `usuarios`(`id_usuario`) ON DELETE
